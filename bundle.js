...
function getWeatherIcon(conditions, datetime, sunrise, sunset) {
  ...
  var normalizedConditions = conditions.toLowerCase().split(',').map(function (condition) {
  ...
  var _iterator = _createForOfIteratorHelper(normalizedConditions),
    _step;
  try {
