...
function _getWeather() {
  _getWeather = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(location) {
    var url, response, data, currentCondition;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/".concat(location, "?key=").concat(visualCrossingKey);
          _context.prev = 1;
          _context.next = 4;
          return fetch(url);
        case 4:
...
console.log('Hello, WeatherWise App!');

(0,_api_js__WEBPACK_IMPORTED_MODULE_0__.getWeather)('Seattle');
})();
